...
export class DeliveryDetails {
	constructor(page) {
		...
		this.savedAddressLastName = page.locator('[data-qa="data-qa="saved-address-lastName"]')
		this.savedAddressStreet = page.locator('[data-qa="data-qa="saved-address-street"]')
		this.savedAddressPostcode = page.locator('[data-qa="data-qa="saved-address-postcode"]')
		this.savedAddressCity = page.locator('[data-qa="data-qa="saved-address-city"]')
		this.savedAddressCountry = page.locator('[data-qa="data-qa="saved-address-country"]')
